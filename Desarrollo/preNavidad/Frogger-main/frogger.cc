...
void LoadSprites(){
  ...
  // Para documentacion cambiar los sprites de globales a locales  y te aorras la funciond de release
...
void TibujarTime(){
  ...
  float TimeSpace[10] = {//              x                            |        y
                      ((ScreenX - 500) + (SecondWidth*SecondPassed)), (ScreenY - 24),   // Punto cord 1 que se mueve con el tiempo
                      (ScreenX - 100)                               , (ScreenY - 24),   // Punto cord 2
                      (ScreenX - 100)                               , (ScreenY - 5),    // Punto cord 3
                      ((ScreenX - 500) + (SecondWidth*SecondPassed)), (ScreenY - 5),    // Punto cord 4 que se mueve con el tiempo
                      ((ScreenX - 500) + (SecondWidth*SecondPassed)), (ScreenY - 24),   // Cierre
                      };
